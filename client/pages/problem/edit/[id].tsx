...
const EditProblemPage: NextPageWithLayout<IEditProblemPage> = ({
...
EditProblemPage.getLayout = (page) => {
  return <PrimaryLayout justify={'items-start'}>{page}</PrimaryLayout>;
};

export const getServerSideProps: GetServerSideProps<IEditProblemPage> = async (
  _context
) => {

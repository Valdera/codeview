...
func (s *problemService) CreateProblem(ctx context.Context, body *dto.ProblemCreate) (*dto.ProblemResponse, error) {
...
func (s *problemService) GetProblems(ctx context.Context, p *pagination.Pagination) ([]dto.ProblemResponse, error) {
...
func (s *problemService) GetProblemById(ctx context.Context, id uint) (*dto.ProblemResponse, error) {
...
func (s *problemService) GetProblemsByIds(ctx context.Context, ids []uint, p *pagination.Pagination) ([]dto.ProblemResponse, error) {
...
func (s *problemService) UpdateProblemById(ctx context.Context, id uint, body *dto.ProblemUpdate) (*dto.ProblemResponse, error) {
